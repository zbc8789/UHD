TARGET_BOARD_INFO_FILE := device/nexell/s5p4418_drone/board-info.txt
...
# certificate
#PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/nexell/security/s5p4418_drone/release

# opengl
BOARD_EGL_CFG := device/nexell/s5p4418_drone/egl.cfg
...
# sepolicy
BOARD_SEPOLICY_DIRS := \
	device/nexell/s5p4418_drone/sepolicy
