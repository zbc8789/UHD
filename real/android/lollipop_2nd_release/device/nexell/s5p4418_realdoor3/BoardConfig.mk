TARGET_BOARD_INFO_FILE := device/nexell/s5p4418_real_door3/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := s5p4418_real_door3
...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/s5p4418_real_door3/recovery.fstab

#TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/s5p4418_real_door3
#TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_s5p4418_real_door3
#TARGET_RECOVERY_UI_LIB := librecovery_ui_s5p4418_real_door3
...
# certificate
#PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/nexell/security/s5p4418_real_door3/release

# opengl
BOARD_EGL_CFG := device/nexell/s5p4418_real_door3/egl.cfg
...
# sepolicy
BOARD_SEPOLICY_DIRS := \
	device/nexell/s5p4418_real_door3/sepolicy
