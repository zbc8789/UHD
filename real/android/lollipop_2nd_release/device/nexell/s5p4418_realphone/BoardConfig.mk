TARGET_BOARD_INFO_FILE := device/nexell/s5p4418_realphone/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := s5p4418_realphone
...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/s5p4418_realphone/recovery.fstab

TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/s5p4418_realphone
TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_s5p4418_realphone
...
# certificate
#PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/nexell/security/s5p4418_realphone/release

# opengl
BOARD_EGL_CFG := device/nexell/s5p4418_realphone/egl.cfg
...
WIFI_DRIVER_MODULE_ARG := "iface_name=wlan firmware_path=/system/etc/firmware/fw_bcm43438a0.bin nvram_path=/system/etc/firmware/nvram_ap6212.txt"
endif
...
# sepolicy
BOARD_SEPOLICY_DIRS := \
	device/nexell/s5p4418_realphone/sepolicy
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 13000000000
