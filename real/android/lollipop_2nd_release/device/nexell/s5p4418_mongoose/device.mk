...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/boot/2ndboot.bin:2ndbootloader
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/init.s5p4418_mongoose.rc:root/init.s5p4418_mongoose.rc \
	device/nexell/s5p4418_mongoose/init.s5p4418_mongoose.usb.rc:root/init.s5p4418_mongoose.usb.rc \
	device/nexell/s5p4418_mongoose/init.recovery.s5p4418_mongoose.rc:root/init.recovery.s5p4418_mongoose.rc \
	device/nexell/s5p4418_mongoose/fstab.s5p4418_mongoose:root/fstab.s5p4418_mongoose \
	device/nexell/s5p4418_mongoose/ueventd.s5p4418_mongoose.rc:root/ueventd.s5p4418_mongoose.rc \
	device/nexell/s5p4418_mongoose/adj_lowmem.sh:root/adj_lowmem.sh 
...
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/busybox:busybox\
	device/nexell/s5p4418_mongoose/busybox:system/bin/busybox

################################################################################
# key
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/nxp-keypad.kl:system/usr/keylayout/nxp-keypad.kl \
	device/nexell/s5p4418_mongoose/nxp-keypad.kcm:system/usr/keychars/nxp-keypad.kcm

################################################################################
# touch
################################################################################
PRODUCT_COPY_FILES += \
    device/nexell/s5p4418_mongoose/gslX680.idc:system/usr/idc/gslX680.idc
...
################################################################################
#PRODUCT_COPY_FILES += \
	#device/nexell/s5p4418_mongoose/vold.fstab:system/etc/vold.fstab
...
# mixer paths
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/audio/tiny_hw.s5p4418_mongoose.xml:system/etc/tiny_hw.s5p4418_mongoose.xml
# audio policy configuration
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/audio/audio_policy.conf:system/etc/audio_policy.conf

################################################################################
# media, camera
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/media_codecs.xml:system/etc/media_codecs.xml \
	device/nexell/s5p4418_mongoose/media_profiles.xml:system/etc/media_profiles.xml
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_mongoose/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
DEVICE_PACKAGE_OVERLAYS := \
	device/nexell/s5p4418_mongoose/overlay
...
PRODUCT_PACKAGES += \
	VolantisLayouts5p4418_mongoose
