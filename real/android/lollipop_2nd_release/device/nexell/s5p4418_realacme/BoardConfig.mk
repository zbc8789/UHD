TARGET_BOARD_INFO_FILE := device/nexell/s5p4418_realacme/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := s5p4418_realacme
...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/s5p4418_realacme/recovery.fstab

#TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/s5p4418_realacme
#TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_s5p4418_realacme
#TARGET_RECOVERY_UI_LIB := librecovery_ui_s5p4418_realacme
...
# certificate
#PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/nexell/security/s5p4418_realacme/release

# opengl
BOARD_EGL_CFG := device/nexell/s5p4418_realacme/egl.cfg
...
# sepolicy
BOARD_SEPOLICY_DIRS := \
	device/nexell/s5p4418_realacme/sepolicy
